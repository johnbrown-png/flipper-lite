        ...
        return [
            {
                ...
                'rank': rank,
                'variant': 1,
                'prompt_text': 'What are the three parts that make this whole?',
                'visual_type': 'part_whole_model',
                'visual_params': json.dumps({'total': 347, 'parts': [300, 40, 7], 'label': False}),
                'answer_type': 'text_match',
                'correct_answer': '300, 40, and 7',
                'options': None,
                'difficulty': 'easy'
            },
            {
    ...
    def _thousands(self, ss_num, ss_name, video_id, rank):
        ...
        return [
            ...
            },
            {
                ...
                'visual_type': 'number_line',
                'visual_params': json.dumps({'start': 0, 'end': 2000, 'interval': 100, 'highlight': None, 'label': False}),
                'answer_type': 'numeric',
                'correct_answer': '20',
                'options': None,
                'difficulty': 'hard'
    ...
    def _flexible_partition_to_10000(self, ss_num, ss_name, video_id, rank):
        ...
        return [
            ...
            },
            {
                ...
                'visual_type': 'part_whole_model',
                'visual_params': json.dumps({'total': 5693, 'parts': [5000, 600, 90, 3], 'label': False}),
                'answer_type': 'numeric',
                'correct_answer': '1600',
                'options': None,
                'difficulty': 'hard'
