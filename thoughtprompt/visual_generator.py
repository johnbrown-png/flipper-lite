...
class MathVisualGenerator:
    ...
    def __init__(self, default_width=800, default_height=400):
        ...
        try:
            ...
            # Larger fonts for part-whole models (+71%): 36→61, 24→42
            self.font_large_pw = ImageFont.truetype("arial.ttf", 61)
            self.font_medium_pw = ImageFont.truetype("arial.ttf", 42)
        except:
